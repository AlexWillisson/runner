package  
{
	...
	{		
		...
		// [Embed(source = 'SpriteLeg1.png')] public static var OneArm:Class;
		// [Embed(source = 'SpriteLeg1.png')] public static var TwoArms:Class;
		// [Embed(source = 'SpriteLeg1.png')] public static var FullPlayer:Class;
